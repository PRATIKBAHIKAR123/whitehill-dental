...
export default function FloatingPromo() {
  ...
  const handleCardClick = () => {
    router.push("/teeth-whitening-offer-levittown-pa"); // Redirect to the offers page
  };
        ...
        <div className="p-1.5 md:p-2">
          <div className="flex items-start gap-2">
            ...
            <div className="flex-shrink-0 w-8 h-8 md:w-10 md:h-10 flex items-center justify-center">
              <img src="/Images/White Hill Logo Scaled.png" alt="Whitening Icon" className="w-auto h-auto" />
            </div>
