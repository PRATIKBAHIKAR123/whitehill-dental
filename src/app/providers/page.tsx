...
const providers = [
    {
        ...
        link: "/providers/steven-reff-levittown-pa-dentist",
    },
        {
        name: "Dr. Kinjal Mehta, DDS ",
        image: "/Images/Team/Kinjal Mehta.png",
        link: "/providers/kinjal-mehta-levittown-pa-dentist",
    },
            {
        name: "Dr. Manreet Kaur, DDS",
        image: "/Images/Team/Dr. Manreet Kaur.png",
        link: "/providers/manreet-kaur-levittown-pa-dentist",
    },
];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white pb-12">
            ...
            <div className="details-page-header-section">
                <h1 >Your Levittown Dental Team - Skilled, Kind & Here for You </h1>
                <h2>Where Advanced Dentistry Meets Genuine Care</h2>
            </div>
