      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-primary mb-6">
            Helping You Get the Most from Your Insurance + Easy Financing Options
          </h2>
          <p className="text-lg max-w-3xl mx-auto leading-relaxed">
            At <strong>White Hill Dental</strong>, cost should never get in the way of a healthy smile. We accept most major insurance plans - including Medicaid - and our team helps you maximize benefits. No insurance? We offer affordable specials and <strong>0% interest financing</strong> to keep quality dental care accessible for every family.
          </p>
        </div>
