...
const banners = [
  ...
  },
  {
    ...
    title: "Join Us Today - New Patient Exam for $79",
    subtitle:
      "Your First Step Toward a Healthier Smile - Exam, Cleaning & Digital X-rays Included",
    ...
    <div>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {/* Medical Cross */}
          <div className="absolute top-24 left-32 text-blue-300/30 text-4xl font-light">
            +
          </div>
              ...
              <div className="w-full">
                ...
                <div className="max-w-3xl text-white">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-4">
                    <button
                      className="bg-white text-cyan-600 px-8 py-2 md:py-3 rounded-full font-semibold text-md hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
        ...
        <div className="w-full relative mt-4">
          ...
          <div className="text-center mb-8  mx-auto px-4 md:px-6">
            ...
            <h2 className="text-3xl md:text-5xl font-semibold leading-tight">
              Family-Focused Dentistry in Levittown, PA
            </h2>
                  ...
                  <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-white to-primary-50/50 border border-blue-100/50 shadow-sm hover:shadow-lg transition-all duration-300 group-hover:border-blue-300/50">
                    ...
                    <div className="px-8 py-6 relative">
                      ...
                      <div className="relative flex items-center gap-3">
                        ...
                        {/* Arrow Icon */}
                        <svg
                          className="w-4 h-4 text-gray-400 group-hover:text-secondary group-hover:translate-x-1 transition-all duration-300"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
      ...
      <section className="relative w-full mt-10 mx-auto px-4">
        <h2 className="text-center text-3xl md:text-5xl font-extrabold my-10">
          Your Local Emergency Dentist in Levittown, PA
        </h2>

        <h4 className="text-center text-md md:text-2xl mb-5">
          Dental emergencies are stressful - but you’re not alone. White Hill Dental in Levittown, PA offers quick, compassionate care to restore comfort fast.
        </h4>
        ...
        <div className="relative max-w-4xl mx-auto px-4 bg-white/10 backdrop-blur-sm rounded-2xl p-3 md:p-8 border border-white/20">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              Comfortable Care in the Language You Prefer
            </h3>
            ...
            <p className="text-blue-100 text-lg mb-8 text-center">
              We’re here to help - in the language that makes you feel at ease.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button
                onClick={() => setIsBookingOpen(true)}
                className="inline-flex items-center justify-center gap-3 bg-transparent border-2 border-white text-white font-semibold py-4 px-8 rounded-xl hover:bg-white/10 transition-colors duration-200 w-full sm:w-auto min-w-[200px] h-[56px]"
              >
      ...
      <section className="w-full bg-gradient-to-br from-white to-sky-50 relative overflow-hidden py-10 md:py-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 md:gap-20 px-6 md:px-8">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
            <h2 className="text-3xl md:text-5xl font-semibold text-primary leading-tight">
              Exclusive Dental Offers Made Just for You
            </h2>

            <p className="text-lg ">
              We’re committed to making high-quality dental care easier and more affordable for every patient. That’s why <strong>White Hill Dental</strong> provides special pricing to help you save on the treatments your family needs:
            </p>
              ...
              <ul className="list-disc gap-3 mt-2 px-6">
                <li className="list-disc">
                  <div className="flex gap-2 ">
                    <span>
                      <strong>Fast relief with a $55 Emergency Visit</strong>{" "}
                    </span>
                  </div>
                </li>
                <li className="list-disc">
                  <div className="flex gap-2">
                    <span>
                      <strong>
                        $79 Smile Starter Package - Cleaning, Exam & Digital X-rays
                      </strong>{" "}
                    </span>
                  </div>
                </li>
                <li className="list-disc">
                  <div className="flex gap-2">
                    <span>
                      <strong>Easy monthly payments with 0% financing</strong>{" "}
                    </span>
                  </div>
                </li>
                <li className="list-disc">
                  <div className="flex gap-2">
                    <strong>Exclusive senior discounts available</strong>
                  </div>
                </li>
              </ul>
            </p>
