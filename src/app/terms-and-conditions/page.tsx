...
const termsSections = [
  {
    ...
    icon: "/Images/White Hill Logo Scaled.png",
  ...
  },
  {
    title: "Notices",
    icon: "/Images/White Hill Logo Scaled.png",
    content: `Please contact us by phone at +1 (215) 607-7200 or by mail at 1146 Bristol Oxford Valley Rd, Levittown, PA 19057, United States`,
  },
];
...
const contactInfo = {
  ...
  hours: "Monday - Thursday: 8:00 AM - 5:30 PM, Saturday: 8:30 AM - 3:00 PM, Friday and Sunday: Closed",
};
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <div className="text-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <Phone size={16} className="text-white" />                  </div>
                  <h3 className="font-semibold text-primary mb-1 sm:mb-2 text-sm sm:text-base">Phone</h3>
                  <p className="text-center text-xs sm:text-sm">{contactInfo.phone}</p>
                </div>

                {/* <div className="text-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <Mail size={16} className="text-white" />                   </div>
                  <h3 className="font-semibold text-primary mb-1 sm:mb-2 text-sm sm:text-base">Email</h3>
                  <p className=" text-xs sm:text-sm text-center">{contactInfo.email}</p>
                </div> */}

                <div className="text-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <MapPin size={20} className="mt-0.5 text-white" />                  </div>
                  <h3 className="font-semibold text-primary mb-1 sm:mb-2 text-sm sm:text-base">Address</h3>
                  <p className=" text-xs sm:text-sm text-center">{contactInfo.address}</p>
                </div>

                <div className="text-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <Clock size={16} className="mt-0.5 text-white" />                  </div>
                  <h3 className="font-semibold text-primary mb-1 sm:mb-2 text-sm sm:text-base">Hours</h3>
                  <p className=" text-xs sm:text-sm text-center">{contactInfo.hours}</p>
                </div>
              </div>
