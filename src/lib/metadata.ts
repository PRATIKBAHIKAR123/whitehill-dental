...
export function generateServiceMetadata(
  ...
  return {
    ...
    openGraph: {
      title: service.title,
      description: service.description,
      url: `https://www.urbandentalnj.com/services/${serviceKey}`,
      images: imageUrl
        ? [
            {
              url: imageUrl,
    ...
    alternates: {
      canonical: `https://www.urbandentalnj.com/services/${serviceKey}`,
    },
  };
}
...
export function generateServiceAreaMetadata(
  ...
  return {
    ...
    openGraph: {
      title: area.title,
      description: area.description,
      url: `https://www.urbandentalnj.com/service-areas/${areaKey}`,
      images: imageUrl
        ? [
            {
              url: imageUrl,
    ...
    alternates: {
      canonical: `https://www.urbandentalnj.com/service-areas/${areaKey}`,
    },
  };
}
...
export function generateProviderMetadata(
  ...
  return {
    ...
    openGraph: {
      title: provider.title,
      description: provider.description,
      url: `https://www.urbandentalnj.com/providers/${providerKey}`,
      images: imageUrl
        ? [
            {
              url: imageUrl,
    ...
    alternates: {
      canonical: `https://www.urbandentalnj.com/providers/${providerKey}`,
    },
  };
}
...
export function generatePageMetadata(
  ...
  return {
    ...
    openGraph: {
      title: page.title,
      description: page.description,
      url: `https://www.urbandentalnj.com/${pageKey}`,
      images: imageUrl
        ? [
            {
              url: imageUrl,
    ...
    alternates: {
      canonical: `https://www.urbandentalnj.com/${pageKey}`,
    },
  };
}

export function generateBlogMetadata(imageUrl: string = ""): Metadata {
  const blog = metadataConfig["dental-blog"];
  if (!blog) {
    return {
      title: metadataConfig.default.title,
      description: metadataConfig.default.description,
  ...
  return {
    ...
    openGraph: {
      title: blog.title,
      description: blog.description,
      url: `https://www.urbandentalnj.com/dental-blog`,
      images: imageUrl
        ? [
            {
              url: imageUrl,
    ...
    alternates: {
      canonical: `https://www.urbandentalnj.com/dental-blog`,
    },
  };
}
...
export function generateBlogPostMetadata(
  ...
  const post =
    metadataConfig.blogPosts[slug as keyof typeof metadataConfig.blogPosts];
  if (!post) {
    return {
      title: metadataConfig.default.title,
      description: metadataConfig.default.description,
  ...
  return {
    ...
    openGraph: {
      title: post.title,
      description: post.description,
      url: `https://www.urbandentalnj.com/dental-blog/${slug}`,
      images: imageUrl
        ? [
            {
              url: imageUrl,
    ...
    alternates: {
      canonical: `https://www.urbandentalnj.com/dental-blog/${slug}`,
    },
  };
}
